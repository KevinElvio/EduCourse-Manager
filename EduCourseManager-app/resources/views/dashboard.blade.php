                ...
                <main class="flex-grow container mx-auto pt-6 X">
                    ...
                    <div class="mb-10 flex justify-between mt-8">
                        ...
                        <div class="flex space-x-4">
                            <button
                                class="px-4 py-2 bg-blue-500 text-white font-semibold rounded-lg shadow-md hover:bg-blue-900 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-opacity-75 flex"><svg
